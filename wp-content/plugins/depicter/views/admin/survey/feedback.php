...
<div class="depicter-survey-container">
	<div class="depicter-survey-list">
		...
		<form action="#" method="post">
			...
			?>
			<h3><?php esc_html_e( 'If you have a moment, please share why you are deactivating Depicter:', PLUGIN_DOMAIN );?></h3>
			<?php
			...
			<div class="depicter-button-wrapper">
				<input type="button" class="depicter-skip" value="<?php esc_attr_e( 'Skip & Deactivate', PLUGIN_DOMAIN );?>">
				<input type="button" class="depicter-submit" value="<?php esc_attr_e( 'Submit & Deactivate', PLUGIN_DOMAIN );?>" disabled>
			</div>
		</form>
	</div>
</div>
