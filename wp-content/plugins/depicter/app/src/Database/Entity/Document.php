...
class Document extends Model
{
	...
	public function getApiProperties()
	{
		...
		if ( is_file( $uploadDir['basedir'] . '/depicter/preview-images/' . $this->getID() . '.png' ) ) {
			$properties['previewImage'] = $uploadDir['baseurl'] . '/depicter/preview-images/' . $this->getID() . '.png';
		} else {
			$properties['previewImage'] = '';
		}
