		...
		<div class="copyrights">
			<p>
				...
				if( !empty( $copyright_text ) ) {
                    ...
                    printf( esc_html__( '%1$s Desenvolvido por:  %3$s', 'orchid-store' ), '1º Ofício de Registro de Imóveis, Títulos e Documentos de Sinop/MT - '.$copyright_text, 'Orchid Store', '<a href="https://www.1oficiosinop.com.br" rel="author" target="_blank">Departamento de Tecnologia da Informação</a>' ) . "<br/>";
